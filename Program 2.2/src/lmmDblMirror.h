/********************************************************************
File Name: lmmDblMirror.h
Programmer: April Polubiec
Date Written: 04/01/2019
Purpose:  Define properties of DblMirror modules.
...
#ifndef LMMDBLMIRROR_H_
#define LMMDBLMIRROR_H_

#include"lmModule.h"

namespace lmclass {

class lmmDblMirror : public lmModule {
public:
	lmmDblMirror();
	virtual bool out(const unsigned short SIDE) const;
};
